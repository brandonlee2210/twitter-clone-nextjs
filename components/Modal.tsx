...
const Modal = ({
  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outlinte-none focus:outline-none bg-neutral-800 bg-opacity-70">
